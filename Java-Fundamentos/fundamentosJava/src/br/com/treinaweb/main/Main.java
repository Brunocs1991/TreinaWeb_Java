		...
		while (acao > 0) {
			if (acao == 1) {
				...
				try {
					...
					System.out.println(String.format("Ocorreu um erro no formato: %s. O primeiro número assumirá o valor 1", e.getMessage()));
					scanner.nextLine();
					numero1=1;
				}
				...
				try {
					...
					System.out.println(String.format("Ocorreu um erro no formato: %s. O segundo número assumirá o valor 1", e.getMessage()));
					scanner.nextLine();
					numero2=1;
				}
