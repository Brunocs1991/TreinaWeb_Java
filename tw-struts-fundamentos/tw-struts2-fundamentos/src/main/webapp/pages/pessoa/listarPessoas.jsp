...
<body>
	...
	<s:url action="paginaCadastroPessoa" var="paginaCadastroPessoaUrl">
	</s:url>
		...
		<tbody>
			<s:iterator value="pessoas">
				<tr>
					...
					<!-- mostraPessoa?id=1 -->
					<td><s:url action="mostrarPessoa" var="mostrarPessoaUrl">
							<s:param name="id">
								<s:property value="id" />
							</s:param>
						</s:url> <s:a href="%{mostrarPessoaUrl}">Mostrar</s:a></td>
				</tr>
			</s:iterator>
		</tbody>
	</table>
